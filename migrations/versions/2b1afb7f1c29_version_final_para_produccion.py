"""Version final para produccion

Revision ID: 2b1afb7f1c29
Revises: 
Create Date: 2026-02-22 12:41:55.313996
...
def upgrade():
    ...
    op.create_table('registro_historial',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('vehiculo_patente', sa.String(length=10), nullable=False),
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('registro_historial')
